        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 p-6">
          ...
          {sent ? (
            <div className="text-center py-8">
              ...
              <button onClick={() => setSent(false)} className="mt-5 px-5 py-2 rounded-xl bg-violet-600 text-white text-sm font-semibold cursor-pointer border-none">
                Написать ещё
              </button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button type="submit" className="w-full py-3 rounded-xl bg-violet-600 hover:bg-violet-700 text-white font-semibold text-sm transition-all cursor-pointer border-none">
                Отправить
              </button>
            </form>
          )}
