...
export default function Likes() {
  ...
  const addCart = (id) => setCart((prev) => ({ ...prev, [id]: true }));
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 dark:text-zinc-500 text-sm mb-6">Добавьте товары нажав на сердечко</p>
              ...
              <div key={product.id} className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="p-4">
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer border-none
